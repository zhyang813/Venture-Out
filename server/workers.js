...
module.exports = {
  ...
  fetchTM: function () {
    ...
    var url = 'https://app.ticketmaster.com/discovery/v2/events.json?apikey=EHAU7JI8sxVlrnoDKQD0Ylr01o9cdudk&size=60&countryCode=US&startDateTime='+currentDate+'T00:00:00Z';
    Request.get(url).then(function(response) {
      response.body._embedded.events.forEach(function(event) {
       //console.log('response event ',count, ' : ', event.name);
         // console.log('=====================================');

          //var imgUrl = event.images[event.images.length-1].url
          Event.findEvent(event.id, function() {
            var newEvent  = {
              ...
              //eventEndTime: event.dates.end.dateTime,
